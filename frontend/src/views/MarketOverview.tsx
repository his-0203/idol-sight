...
const HELP = {
  ...
  core:      "추정 코어 = 최근 56일 영상 중 좋아요 상위 5편의 중앙값(고유 반응 팬 근사). 유료 의심(suspect/likely_paid) 영상은 제외. 산식 v2(2026-08): 상위 5편 기준이라 업로드 편수가 많아도 불리하지 않음 — 전 그룹 동일 적용. 추정 휴리스틱 — 실측 아님.",
  quad:      "넓이(인지도)×깊이(적극 코어=최근 56일 댓글 상위 5편 중앙값) 사분면. 진성강세=둘 다 높음 · 광고형/바이럴=넓지만 얕음 · 니치 충성=좁지만 깊음 · 저조=둘 다 낮음 (카테고리 중앙값 기준). 사분면의 인지도는 할인 전 원값 — '넓지만 얕음(광고형)' 패턴 탐지가 목적.",
